...
const transcribePdf = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.file) {
    ...
    const response = yield model.generateContent(data_1.extractDataPrompt + text);
    const extractedData = response.response.text();
    console.log(extractedData);
    const jsonString = JSON.parse(extractedData.slice(8, extractedData.length - 4));
    if (jsonString.error) {
...
const transcribeImage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let filePath = null;
    try {
        if (!req.file) {
